package cn.wnhyang.okay.admin.convert.menu;

import cn.hutool.core.collection.CollUtil;
import cn.wnhyang.okay.admin.entity.MenuDO;
import cn.wnhyang.okay.admin.enums.permission.MenuTypeEnum;
...
import static cn.wnhyang.okay.admin.entity.MenuDO.ID_ROOT;
...
public interface MenuConvert {
    ...
    List<MenuSimpleTreeRespVO> convert02(List<MenuDO> list);

    List<MenuTreeRespVO> convert(List<MenuDO> menus);
}
